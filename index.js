...
const shazia = new Person("Shazia", 26);
const sabrina = new Person("Sabrina", 29);

console.log(shazia.toString());
console.log(sabrina.toString());
...
const developer = new Lambdasian({
  name: "Muniba",
  age: 28,
  location: "California",
});
